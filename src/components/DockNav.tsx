...
const DockNav = () => {
  ...
  return (
    <motion.nav
      ...
      className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 px-4 py-3 rounded-[2rem] flex items-end gap-1 backdrop-blur-[60px] border border-[hsl(var(--glass-border))]"
      style={{
