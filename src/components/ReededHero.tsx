...
const ReededHero = () => (
  <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[hsl(var(--background))]">
    ...
    <div className="absolute inset-0 z-[3] pointer-events-none overflow-hidden">
      <motion.div
        ...
        style={{
          background: "radial-gradient(ellipse at center bottom, hsl(var(--foreground) / 0.06) 0%, transparent 70%)",
        }}
      ...
      <motion.div
        ...
        style={{
          background: "radial-gradient(ellipse at center, hsl(var(--foreground) / 0.04) 0%, transparent 70%)",
        }}
    ...
    <div className="absolute bottom-36 sm:bottom-32 left-1/2 -translate-x-1/2 z-[15] text-center">
      ...
      >
        ...
        <a
          href="#results"
          className="text-sm uppercase tracking-widest text-muted-foreground hover:text-foreground transition-colors underline underline-offset-4 decoration-muted-foreground/40"
        >
          Client Results
        </a>
      </motion.div>
